...
num2 = Math.floor(Math.random()*2);
	...
	indiceOpCorrecta = Math.floor(Math.random()*2);
	console.log(indiceOpCorrecta);

	//si indiceCorrrecta es igual 0
	if(indiceOpCorrecta == 0){
		op1.innerHTML = parseInt(respuesta) ;
		op2.innerHTML = parseInt(respuesta) + 1;
		op3.innerHTML = parseInt(respuesta) + 1
	}
	if(indiceOpCorrecta == 1){
		op1.innerHTML = parseInt(respuesta)+1;
		op2.innerHTML = parseInt(respuesta);
		op3.innerHTML = parseInt(respuesta) + 2;
	}
	if(indiceOpCorrecta == 2){
		op1.innerHTML = parseInt(respuesta)+ 2;
		op2.innerHTML = parseInt(respuesta) + 3;
		op3.innerHTML = parseInt(respuesta);
	}
}
